...
const NAV_ITEMS = [
  ...
  { href: '/call-center/rx-processing/', icon: 'fa-file-prescription', label: 'Rx Processing', key: 'cc-rx-processing' },
  { href: '/call-center/tracking/', icon: 'fa-truck-fast', label: 'Shipping & Tracking', key: 'cc-tracking' },
  { href: '/call-center/review-close/', icon: 'fa-clipboard-check', label: 'Review & Close', key: 'cc-review-close' },
...
function initNav(activeKey) {
  ...
  const pageTitles = {
    ...
    'cc-rx-processing': 'Call Center — Rx Processing',
    'cc-tracking': 'Call Center — Shipping & Tracking',
    'cc-review-close': 'Call Center — Review & Close',
